...
public class Main {
    ...
    private static void display(char[][] stare) {
        System.out.println("---------");
        System.out.println("| " + stare[0][0] + ' ' + stare[0][1] + ' ' + stare[0][2] + " |");
        System.out.println("| " + stare[1][0] + ' ' + stare[1][1] + ' ' + stare[1][2] + " |");
        System.out.println("| " + stare[2][0] + ' ' + stare[2][1] + ' ' + stare[2][2] + " |");
        System.out.println("---------");
    }
